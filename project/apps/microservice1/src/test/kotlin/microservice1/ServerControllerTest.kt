...
@MicronautTest
class ServerControllerTest(private val embeddedServer: EmbeddedServer) {
    ...
    fun testIndex() {
        ...
        assertEquals(HttpStatus.OK, client.toBlocking().exchange("/server", String::class.java).status())
        client.close()
    }
}
